...
'我不会离开，你可以一遍又一遍的向我确认。',
'今天她和我说找到男朋友了，然后把我拉黑了。我一定是个特别的人吧，那不然她为什么不拉黑别人只拉黑我呢。',
'问你在干嘛，你回我能不能别烦你。你居然在询问我的意见，态度真好，真喜欢你。',
  '今天又去你们宿舍楼下等你来着，怕你见不到我，就会吃太多。因为前天约你吃饭的时候 你说你不想去，夏天要来了，你要减肥。昨天你又说，看到我就恶心。',
'',
];
...
document.getElementById('date').innerHTML = new Date().format("yyyy-MM-dd")
